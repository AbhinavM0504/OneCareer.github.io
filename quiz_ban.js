...
submit.addEventListener('click',()=>{
    ...
    if(questioncount<quizDB.length)
    {
        ...
        <a href="start.html"><button class="btn" style="color: #003333";>Go back to start menu</button></a>
        `;
        else{
            showScore.innerHTML=`
            <h2>You Scored ${score}/${quizDB.length}.You are good to go.</h2>
            <a href="start.html"><button class="btn" style="color: #003333";>Go back to course</button></a>
            `;
        }
